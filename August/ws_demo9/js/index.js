$(document).ready(function () {
    ...
    $li.click(function () {
        ...
        switch (index) {
            case 1:
                $ul.next('.selected').html('套餐一说明：穹窿山门票50元/张（原价80元）+ 石榴45.8元/箱（原价75元）');
                break;
            case 2:
                $ul.next('.selected').html('套餐二说明：万鸟园门票30元/张（原价60元）+ 石榴45.8元/箱（原价75元）');
                break;
            case 3:
                $ul.next('.selected').html('套餐三说明：孙武文化园门票40元/张（原价80元）+ 石榴45.8元/箱（原价75元）');
                break;
            case 4:
            ...
            case 6:
                ...
                break;
            default :
                $ul.next('.selected').html('石榴单品说明：石榴单果重8两，六个装45.8元（原价75元）');
        }
    });
